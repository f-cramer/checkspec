    ...
    private static LevenshteinResults findDetailedResults(final CharSequence left,
        ...
        while (rowIndex >= 0 && columnIndex >= 0) {
            ...
            if (data - 1 == dataAtLeft && (data <= dataAtDiagonal && data <= dataAtTop)
                ...
                if (swapped) {
                	System.out.println("added1 " + left.charAt(columnIndex - 1));
                    addCount++;
                    added = true;
                } else {
                	System.out.println("deleted2 " + right.charAt(rowIndex - 1));
                    delCount++;
                    deleted = true;
                }
                columnIndex--;
                ...
                if (swapped) {
                	System.out.println("deleted3 " + left.charAt(columnIndex - 1));
                    delCount++;
                    deleted = true;
                } else {
                	System.out.println("added4 " + right.charAt(rowIndex - 1));
                    addCount++;
                    added = true;
                }
                rowIndex--;
            ...
            if (!added && !deleted) {
            	if (swapped) {
            		System.out.println("substituted " + right.charAt(rowIndex - 1) + " with " + left.charAt(columnIndex - 1));
            	} else {
            		System.out.println("substituted " + left.charAt(columnIndex - 1) + " with " + right.charAt(rowIndex - 1));
            	}
                subCount++;
                columnIndex--;
                rowIndex--;
